package cn.com.xdays.xshop.action.admin;
...
import cn.com.xdays.xshop.entity.DeliveryCorp;
import cn.com.xdays.xshop.entity.DeliveryItem;
import cn.com.xdays.xshop.entity.DeliveryType;
...
import cn.com.xdays.xshop.entity.Order.OrderStatus;
import cn.com.xdays.xshop.entity.Order.ShippingStatus;
import cn.com.xdays.xshop.entity.OrderLog.OrderLogType;
import cn.com.xdays.xshop.entity.Payment.PaymentStatus;
import cn.com.xdays.xshop.entity.Payment.PaymentType;
import cn.com.xdays.xshop.entity.Product.WeightUnit;
import cn.com.xdays.xshop.entity.Refund.RefundType;
import cn.com.xdays.xshop.service.AdminService;
import cn.com.xdays.xshop.service.AreaService;
import cn.com.xdays.xshop.service.DeliveryCorpService;
import cn.com.xdays.xshop.service.DeliveryItemService;
import cn.com.xdays.xshop.service.DeliveryTypeService;
...
import cn.com.xdays.xshop.service.OrderItemService;
import cn.com.xdays.xshop.service.OrderLogService;
import cn.com.xdays.xshop.service.OrderService;
import cn.com.xdays.xshop.service.PaymentConfigService;
import cn.com.xdays.xshop.service.PaymentService;
import cn.com.xdays.xshop.service.ProductService;
import cn.com.xdays.xshop.service.RefundService;
import cn.com.xdays.xshop.service.ReshipService;
import cn.com.xdays.xshop.service.ShippingService;
...
public class OrderAction extends BaseAdminAction {
	...
	public String edit() {
		...
		if (order.getPaymentStatus() != cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid) {
	...
	public String update() {
		...
		if (persistent.getPaymentStatus() != cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid) {
			addActionError("此订单付款状态无法编辑！");
			return ERROR;
		}
		...
		for (OrderItem orderItem : orderItemList) {
			...
			if (product.getStore() != null) {
				...
				if ((getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.payment && order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid) || 
				...
				if (getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.order || (getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.payment && order.getPaymentStatus() != cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid) || 
					(getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.ship && order.getShippingStatus() != ShippingStatus.unshipped)) {
	...
	public String payment() {
		...
		if (order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.paid || order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.partRefund || order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.refunded) {
		...
		// 库存处理
		if (getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.payment && order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid && order.getShippingStatus() == ShippingStatus.unshipped) {
		...
		order.setOrderStatus(OrderStatus.processed);
		if (payment.getTotalAmount().compareTo(order.getTotalAmount().subtract(order.getPaidAmount())) == 0) {
			order.setPaymentStatus(cn.com.xdays.xshop.entity.Order.PaymentStatus.paid);
		} else {
			order.setPaymentStatus(cn.com.xdays.xshop.entity.Order.PaymentStatus.partPayment);
		}
		...
		for (DeliveryItem deliveryItem : deliveryItemList) {
			...
			for (OrderItem orderItem : orderItemSet) {
				if (product == orderItem.getProduct()) {
					...
					if (product.getStore() != null) {
						if ((getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.payment && order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid && order.getShippingStatus() == ShippingStatus.unshipped) || (getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.ship && order.getShippingStatus() == ShippingStatus.unshipped)) {
	...
	public String refund() {
		...
		if (order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid || order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.refunded) {
			addActionError("此订单付款状态无法支付！");
			return ERROR;
		}
		...
		order.setOrderStatus(OrderStatus.processed);
		if (refund.getTotalAmount().compareTo(order.getPaidAmount()) < 0) {
			order.setPaymentStatus(cn.com.xdays.xshop.entity.Order.PaymentStatus.partRefund);
		} else {
			order.setPaymentStatus(cn.com.xdays.xshop.entity.Order.PaymentStatus.refunded);
		}
	...
	public String invalid() {
		...
		if (order.getOrderStatus() == OrderStatus.completed) {
			...
			return ajaxJsonErrorMessage("此订单已经作废！");
		} else if (order.getPaymentStatus() != cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid) {
			...
			// 库存处理
			if (getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.order || (getSystemConfig().getStoreFreezeTime() == StoreFreezeTime.payment && order.getPaymentStatus() != cn.com.xdays.xshop.entity.Order.PaymentStatus.unpaid) || order.getShippingStatus() != ShippingStatus.unshipped) {
				for (OrderItem orderItem : order.getOrderItemSet()) {
					Product product = orderItem.getProduct();
					product.setFreezeStore(product.getFreezeStore() - orderItem.getProductQuantity());
					if (!product.getIsOutOfStock()) {
