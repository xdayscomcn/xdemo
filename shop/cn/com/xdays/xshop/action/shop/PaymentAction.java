package cn.com.xdays.xshop.action.shop;
...
import cn.com.xdays.xshop.entity.PaymentConfig.PaymentConfigType;
...
public class PaymentAction extends BaseShopAction {
	...
	public String gateway() throws Exception {
		...
		if (paymentType == PaymentType.recharge) {
			...
			if (order.getPaymentStatus() == cn.com.xdays.xshop.entity.Order.PaymentStatus.paid) {
