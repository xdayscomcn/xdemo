...
<body class="login">
	<div class="body">
		<div class="loginBox">
			...
			<div class="boxMiddle">
				<form id="loginForm" class="form" action="${base}/sys/loginVerify" method="post">
					<div class="loginLogo">
				    	<img src="${base}/template/admin/images/login_logo.png" />
				    </div>
		            <table class="loginTable">
		                ...
		                <tr>
		                    ...
		                    <td>
		                        ...
		                        <input type="button" class="helpButton ignoreForm" value="帮 助" onclick="window.open('http://help.xdays.com.cn')" hidefocus="true" />
		                    </td>
		                </tr>
		            </table>
		        </form>
		...
		<div class="footer">
			<a href="${base}/">前台首页</a>|
			<a href="http://www.xdays.com.cn">官方网站</a>|
			<a href="http://bbs.xdays.com.cn">官方论坛</a>|
			<a href="http://about.xdays.com.cn">关于我们</a>|
			<a href="http://contact.xdays.com.cn">联系我们</a>| 
			<a href="http://certificate.xdays.com.cn">授权查询</a>
		</div>
	</div>
</body>
</html>